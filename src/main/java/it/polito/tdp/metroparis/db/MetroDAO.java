...
public class MetroDAO {
	...
	public List<Coppie> coppieFermate(Map<Integer, Fermata> fermateIdMap) {
		...
		try {
			...
			while(res.next()) {
				Coppie c= new Coppie(fermateIdMap.get(res.getInt("id_stazP")),fermateIdMap.get(res.getInt("id_stazA")));
				result.add(c);
			}
